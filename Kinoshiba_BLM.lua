...
function get_sets()
	...
	sets.Midcast.EleDot = {
		...
		back={ name="Taranus's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10','Phys. dmg. taken-10%',}},--back="Aurist's Cape +1",
		waist="Acuity Belt +1",
		legs="Arch. Tonban +2",
		feet="Arch Sabots +2",
	}
		...
		if Common_Funcs.Is_In_Party(packet.actor_id) then
			for _, target in pairs(packet.targets) do
				for _, action in pairs(target.actions) do
					...
					if action.has_add_effect and S{288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397, 398}:contains(action.add_effect_message) then
						...
						if mb_timer then coroutine.close(mb_timer) end

...
function get_sets()
	...
	sets.JA.Berserk = {
		body = "Pumm. Lorica +3",
		back = {name = "Cichol's Mantle", augments = {"Accuracy+20 Attack+20", "\"Dbl.Atk.\"+10", "DEX+20"}},
		feet = "Agoge Calligae",
	}
	...
	Weapon_map = {[1] = "Bravura", [2] = "Naegling", [3] = "Shining", [4] = "Loxotic"}
	Weapon_mode = 1
	...
	sets.WS["Savage Blade"] = {legs = "Boii Cuisses +2"}

	sets.WS["Judgement"] = {legs = "Boii Cuisses +2"}

...
function get_sets()
	...
	sets.JA.Compensator = {main = {name = "Lanun Knife", augments = {"Path: C"}}, range = "Compensator"}
	...
	Weapon_map = {[1] = "Fomalhaut", [2] = "Naegling", [3] = "DualWield", [4] = "RangedDW"}
	Weapon_mode = 1

	sets.Weapon = {}
	sets.Weapon.Fomalhaut = {
	...
	sets.TP.Ranged.TripleShot = {body = "Chasseur's Frac +3"}

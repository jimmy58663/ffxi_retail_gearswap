...
function get_sets()
	...
	sets.JA["Last Resort"] = {back={ name="Ankou's Mantle", augments={'Accuracy+20 Attack+20','"Dbl.Atk."+10','DEX+20'}}, feet="Fall. Sollerets +2"}
	...
	sets.Absorb = {head="Ig. Burgeonet +2",neck="Erra Pendant",back={ name="Ankou's Mantle", augments={'Accuracy+20 Attack+20','"Dbl.Atk."+10','DEX+20'}},}
